...
You must configure the `server.xml` to include the [hotspot=EARdefinition file=1]`<enterpriseApplication/>` element to express the location of your EAR application.
