...
Navigate to the `start/ear/src/test/java/it/io/openliberty/guides/multimodules` directory. Open the [hotspot1-52 file=0]`Test.java` file. Helper functions for the integration test class are provided.
