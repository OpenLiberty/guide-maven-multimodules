...
The definition and configuration of the [hotspot=build file=0]`maven-ear-plugin` plug-in were added to create an EAR file. Define the [hotspot=jar-module file=0]`<jarModule/>` and [hotspot=web-module file=0]`<webModule/>` modules to be packaged into the EAR file.
