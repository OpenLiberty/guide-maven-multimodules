...
Next, add the dependencies. Define the [hotspot=16-21 file=0]`Java library module` and the [hotspot=22-27 file=0]`web module` as dependencies. Specify [hotspot=31 file=0]`<type>war</type>` for the web module. If you don’t specify the web module, Maven looks for a JAR file.
