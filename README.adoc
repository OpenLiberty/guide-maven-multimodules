...
[role="code_command hotspot=30-34", subs="quotes"]
----
#Edit the POM file.#
`war/pom.xml`
----
...
----
Go to the dependency section, where you can add more dependencies. Add the [hotspot=30-34 file=0]`<dependency/>` element: the Java library module that implements the functions that you need for the unit converter.
