...
:page-tags: []
:page-seo-title: Building a multi-module Java application with Maven and Open Liberty
:page-seo-description: A tutorial on how to use Maven to build a Java EE application with multiple modules consisting of JAR, WAR, and EAR projects.
